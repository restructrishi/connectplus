...
export declare const leadService: {
    ...
    convertToOpportunity(id: string, reason: string, userId: string, userRole: CrmRole): Promise<{
        id: string;
        name: string;
        status: import("../../../../generated/prisma-client/index.js").$Enums.LeadLifecycleStatus;
        assignedTo: string | null;
    ...
    markDead(id: string, reason: string, userId: string, userRole: CrmRole): Promise<{
        id: string;
        name: string;
        status: import("../../../../generated/prisma-client/index.js").$Enums.LeadLifecycleStatus;
        assignedTo: string | null;
